...
function _Browser_application(impl)
{
	...
	return _Browser_document({
		...
		j: function(flags)
		{
			return A3(impl.j, flags, _Browser_getUrl(), key);
		},
		aC: impl.aC,
		aB: impl.aB,
		az: impl.az
...
var $author$project$Main$init = {j: 0, q: 'P hunch'};
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			j: function (_v0) {
				return _Utils_Tuple2(impl.j, $elm$core$Platform$Cmd$none);
			},
			az: function (_v1) {
		...
		if (!msg) {
			...
			if (!model.j) {
				...
				var newName = A3(
					$elm$core$String$slice,
					0,
					$elm$core$String$length(model.q) - 1,
					model.q);
				return _Utils_update(
					model,
					{j: model.j - 1, q: newName});
			}
		}
	});
...
var $author$project$Main$shakeStyle = function (model) {
	return (!model.j) ? A2(
		$elm$core$List$map,
		function (_v0) {
			var k = _v0.a;
		...
		_List_fromArray(
			[
				_Utils_Tuple2('animation', 'shake 0.3s cubic-bezier(.36,.07,.19,.97) both'),
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					$author$project$Main$shakeStyle(model)),
				_List_fromArray(
					[
						$elm$html$Html$text(
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{j: $author$project$Main$init, aB: $author$project$Main$update, aC: $author$project$Main$view});
